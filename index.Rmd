...
The Bushfires in Victoria and New South Wales last year captured the attention of people worldwide. They caused destruction and devastation for several months. 

The Australian climate is generally hot and dry, and bushfires can occur at anytime of the year for most of the regions [@bushfire]. In this sense, they are seem inevitable. This analysis hopes to understand the relationship between climactic conditions and bushfires, and determine whether climate change has influenced the number of bushfires. 
...
Three datasets have been used to complete this analysis. The cleaned data has been obtained from [GitHub tidytuesday](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-01-07/readme.md). 
...
### When does rainfall occur the most in Australia?
...
Figure \@ref(fig:average-rain) finds that the driest months are September, October and May for Australia???
...
### Which months are bushfires burning? {#month}

### Have the bushfires been more severe in recent years? 
...
Figure \@ref(fig:when) shows some unusual patterns. Firstly, the trend line for the bushfires in 2019 is quite different from other years. This can be explained by the extensive bushfires in Victoria and New South Wales. They have been the biggest bushfires since the European settlement[@nolan2020causes]. 
 
In September 2011, there was far more bushfires than in any other year in the same period. According to @blanchi2014environmental, the bushfires were the result of a combination of low rainfall and strong winds. 

In addition, bushfires are more likely to occur in May and from August to November historically. August to October is the winter to spring period in Australia. These months are typically drier as seen in Figure \@ref(fig:average-rain)??, which can lead to the ignition of forest fuels[@sullivan2012fuel]. 
...
Figure \@ref(fig:state) demonstrates that most bushfires occur in the Northern Territory and Queensland. This is likely to both areas being prone to drought and have high concentrations of vegetation. 

The trend for Victoria and New South Wales (NSW) is relatively stable, with the exception of 2019. As mentioned above, this is due to the catastrophic bushfires that took place over this period. Figure \@ref(fig:map) shows the distribution of bushfires from the end of 2019 to the beginning of 2020. It predominantly captures Victoria and NSW.
...
The most fires occured in 2012 with 474,964 fires, however, the average temperature was relatively low, at 22.57°C. These bushfires can be explained by a lightening strike[@dowdy2012characteristics]. 

Ultimately, the analysis above demonstrates that a high temperature is closely related to bushfires, and means that forest fuels are more likely to catch alight[@oldenborgh2020attribution].
