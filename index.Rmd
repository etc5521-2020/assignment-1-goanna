...
```
```{r average-rain1, fig.cap ="Average monthly rainfall from 2001", warning=FALSE, message=FALSE}
rain_agv <- rainfall %>% 
  filter(year == "2011") %>% 
