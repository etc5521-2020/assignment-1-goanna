...
Figure \@ref(fig:when) shows some unusual patterns. The trend line for the bushfires in 2019 is very different from other years. This is due to the extensive bushfires in Victoria and New South Wales, which were the biggest bushfires since the European settlement [@nolan2020causes].
 
In September 2011, there was far more bushfires than in any other year in the same period. According to @blanchi2014environmental, these bushfires were the result of a combination of low rainfall and strong winds. 

The overall trend line shows that bushfires are more likely to occur from August to November. This is the winter-spring period in Australia. These months are typically drier as seen in Figure \@ref(fig:average-rain)??(I THINK WE ALSO NEED A GRAPH FOR OVERALL AV RAINFALL TO LINK HERE), which can lead to the ignition of forest fuels [@sullivan2012fuel] and thus bushfires. 
...
Figure \@ref(fig:correlation) demonstrated that rainfall and bushfires have a negative correlation, suggesting that more rainfall means fewer bushfires. Additionally, it shows that a higher temperature leads to more bushfires. Although the correlation between these two variables is small, the relationship is still evident. Moreover, when the temperature is higher, there is less rain.
