...
Figure \@ref(fig:correlation-color) shows that rainfall and bushfires have a small negative correlation of 0.3. 

As for temperature and bushfires, the correlation between these two variables is only 0.13. Given this co-efficient is close to zero, there is almost no correlation between temperature and bushfires in the past 20 years.
