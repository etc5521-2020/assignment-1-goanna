...
p1
```
Figure \@ref(fig:when) represent the changing trend of the total number of fires from 2001 to 2020. From this figure, there are three unusual phenomena.  
...
Secondly, Why is the number of fires from August to November significantly higher than in other months? Is it because of the temperature? August to November is Australia's winter and spring. The average temperature is not particularly high, but fall and winter bring drier weather, making the grass dry and ready to catch fire[@sullivan2012fuel]. Is it also because of rainfall? We drew a figure \@ref(fig:average-rain) of the average rainfall of different months between 2001 and 2020. It is obvious that September and October are the months with the least rainfall, and August and November are not particularly rainy, so August to November, One of the reasons for the high number of wildfires relative to other months is the low rainfall.

```{r average-rain, fig.cap ="Average rainfall in different months"}
rain_agv <- rainfall %>% 
  filter(year> "2001") %>% 
...
In summary, when analyzing the existence of fires in Australia, we found that between August and November of each year is the most prone month for fires in Australia. The Northern Territory and Western Australia are the most prone to fires. When it comes to climatic conditions that cause the bushfires in Australia to occur frequently, through the analysis of this article, it can be inferred that first, when the temperature is high, more fires usually occur, and vice versa. Second, the decrease in rainfall and the increase in temperature may be the main reasons for the increase in wildfire area. Finally, Australia’s fires affect the global climate and environment, and people all over the world are concerned about it. We hope this article can give some advice on forest fire prevention.
