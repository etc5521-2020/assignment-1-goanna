...
data_fire_Year  %>%
  ...
  geom_line() +
  geom_text(aes(label = Total_fire), color = "red", vjust = 1.5) +
  xlab("Year") +
  ylab("Number of Fires") +
  ggtitle("Number of Fires by Year") 
```



```{r rainboxplot, fig.cap ="Average monthly rainfall from 2001", warning=FALSE, message=FALSE}
...
ggplot(fire_temp, aes(x=time, y=Total)) +
  geom_line(color=temperatureColor) + 
  geom_line(aes(y=avg), size=2, color=priceColor) +
  scale_y_continuous(name = "Temperature",
    sec.axis = sec_axis(~ ./10000, name="cases")) + 
  theme_ipsum() +
  theme(
